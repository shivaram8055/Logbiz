...
export const Navbar = () => {
    ...
    return (
        <header className='flex justify-between items-center w-11/12 rounded-md fixed bg-black px-6 md:px-8 py-4'>
            ...
            <nav className={`hidden lg:flex justify-start items-center gap-2 w-5/12 ${menuOpen ? 'hidden' : ''}`}>
            ...
            {/* Logo */}
            <NavLink to='/home' className="w-4/12 md:w-1/2 lg:w-4/12 flex justify-start items-center lg:justify-center">
                <img className="w-5/6 md:w-2/6 lg:w-3/12" src="./logo.png" alt="Logbiz Logo" title='Logbiz Logo' />
            </NavLink>
